<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="glass-card p-6 border-brand-500/20">
            <div class="flex justify-between items-start">
                <div>
        ...
        <div class="lg:col-span-2 glass-card p-8">
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex space-x-2">
                    ...
                    <button class="px-3 py-1 rounded-lg bg-brand-500/10 text-brand-500 text-[10px] font-bold uppercase">14 Days</button>
                </div>
            </div>
            <div class="h-64 w-full flex items-end space-x-2">
                @foreach([20, 45, 30, 65, 40, 80, 50, 90, 70, 85, 60, 100, 75, 95] as $val)
                    <div class="flex-1 bg-gradient-to-t from-brand-600 to-indigo-500 rounded-t-sm opacity-80 hover:opacity-100 transition-opacity" style="height: {{ $val }}%;"></div>
                @endforeach
            </div>
    ...
    <div class="glass-card overflow-hidden">
        <div class="p-8 border-b border-white/5 flex justify-between items-center">
            ...
            <a href="/admin/revisions" class="text-[10px] font-bold text-brand-500 uppercase tracking-widest hover:underline">View All Task History</a>
        </div>
            ...
            <tbody class="divide-y divide-white/5">
                @foreach($recent_revisions as $rev)
                    <tr class="hover:bg-white/[0.01] transition-colors">
                        ...
                        <td class="px-8 py-4">
                            <div class="text-sm">Modified <span class="text-brand-400 font-bold">{{ $rev->article->title }}</span></div>
