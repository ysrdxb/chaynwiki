                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="px-10 py-5">
                                <div class="flex flex-col gap-2">
                                    ...
                                    @if($article->is_master)
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-amber-500/10 border border-amber-500/20 text-[9px] font-black uppercase tracking-tighter text-amber-500 animate-pulse">
                            ...
                            <td class="px-10 py-5">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="h-1.5 w-16 bg-white/5 rounded-full overflow-hidden">
                                        <div class="h-full bg-blue-500/50" style="width: {{ $article->data_quality }}%"></div>
                                    </div>
                                    <span class="text-[9px] font-black text-white/20 uppercase">{{ $article->data_quality }}% Quality</span>
                                </div>
                            </td>
                            ...
                            <td class="px-10 py-5">
                                <div class="flex items-center justify-end gap-1.5 group-hover:translate-x-0 transition-transform">
                                    <button wire:click="toggleMaster({{ $article->id }})" class="p-2.5 rounded-xl hover:bg-blue-600/10 hover:text-blue-600 border border-transparent hover:border-blue-600/20 transition-all {{ $article->is_master ? 'text-blue-500 bg-blue-600/10 border-blue-600/20' : 'text-white/20' }}" title="Toggle Master Hierarchy">
