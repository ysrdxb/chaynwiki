<div class="relative min-h-screen bg-primary pt-32 pb-24" x-data="{ loaded: false }" x-init="setTimeout(() => loaded = true, 500)">
    ...
    <div class="fixed inset-0 z-0 pointer-events-none">
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-[#0c4a6e]/10 via-[#050511] to-[#050511]"></div>
    </div>
    ...
    <div class="relative z-10 max-w-[1200px] mx-auto px-8 relative">
        ...
        <div class="bg-secondary border border-white/5 rounded-2xl p-8 md:p-14 mb-16 shadow-2xl relative overflow-hidden group">
            <div class="absolute right-0 top-0 w-[500px] h-[500px] bg-[#38bdf8]/5 blur-[120px] rounded-full -mr-60 -mt-60 transition-all duration-1000 group-hover:bg-[#38bdf8]/10"></div>
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start gap-16 relative z-10">
                ...
                <div class="shrink-0 relative">
                    ...
                    <div class="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-[#38bdf8] px-5 py-2 rounded-xl border border-[#050511] shadow-2xl text-[10px] font-black uppercase tracking-[0.2em] text-[#0a0e14] whitespace-nowrap shadow-[#38bdf8]/20">
                ...
                <div class="flex-1 text-center md:text-left py-2">
                    <div class="mb-10">
                        <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#38bdf8]/5 border border-[#38bdf8]/10 text-[9px] font-black text-[#38bdf8] uppercase tracking-[0.2em] mb-4">
                    ...
                    <div class="flex flex-wrap justify-center md:justify-start gap-10 text-[10px] font-black text-white/10 uppercase tracking-[0.2em] items-center">
                        @if($user->location)
                            <div class="flex items-center gap-2.5">
                                <svg class="w-4 h-4 text-[#38bdf8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path></svg>
                                {{ $user->location }}
                            </div>
                        @endif
                        <div class="flex items-center gap-2.5">
                            <svg class="w-4 h-4 text-[#38bdf8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                ...
                <div class="grid grid-cols-2 gap-4 w-full md:w-80">
                    <div class="bg-primary/40 border border-white/5 rounded-2xl p-6 text-center group/stat hover:border-[#38bdf8]/20 transition-all shadow-xl">
                        <div class="text-3xl font-black text-white group-hover/stat:text-[#38bdf8] transition-colors uppercase italic tracking-tighter">{{ $user->reputation_score }}</div>
                        <div class="text-[9px] text-white/10 uppercase tracking-[0.2em] font-black mt-2">Reputation</div>
                    </div>
                    <div class="bg-primary/40 border border-white/5 rounded-2xl p-6 text-center group/stat hover:border-[#38bdf8]/20 transition-all shadow-xl">
                        <div class="text-3xl font-black text-white group-hover/stat:text-[#38bdf8] transition-colors uppercase italic tracking-tighter">{{ $revisionsCount }}</div>
            ...
            <div class="space-y-8">
                <div class="bg-secondary border border-white/5 rounded-2xl p-6 shadow-xl">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        <div class="aspect-square rounded-xl bg-[#38bdf8]/5 border border-[#38bdf8]/10 flex items-center justify-center text-[#38bdf8] shadow-lg shadow-[#38bdf8]/5">
                ...
                <div class="bg-secondary border border-white/5 rounded-2xl p-6">
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center text-[10px] font-black">
                            ...
                            <span class="text-[#38bdf8] tracking-widest">TIER ALPHA</span>
                        </div>
                        <div class="flex justify-between items-center text-[10px] font-black">
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <div class="space-y-6">
                    @forelse($articles as $article)
                        <a href="{{ route('wiki.show', $article->slug) }}" wire:navigate class="group block bg-secondary border border-white/5 rounded-2xl p-8 hover:border-[#38bdf8]/20 transition-all duration-500 relative overflow-hidden shadow-2xl">
                            <div class="absolute inset-0 bg-[#38bdf8]/[0.01] group-hover:bg-[#38bdf8]/[0.02] transition-colors"></div>
                            
                            <div class="relative flex flex-col md:flex-row md:items-center justify-between gap-10">
                                <div class="flex-1">
                                    <div class="flex items-center gap-4 mb-4">
                                        <span class="px-3 py-1 bg-[#38bdf8]/5 text-[#38bdf8] text-[9px] font-black uppercase tracking-[0.2em] rounded-lg border border-[#38bdf8]/10 shadow-lg">{{ $article->category }}</span>
                                        <span class="text-[9px] font-black text-white/5 uppercase tracking-[0.3em] italic">{{ $article->created_at->diffForHumans() }}</span>
                                    </div>
                                    <h4 class="text-2xl font-black text-white group-hover:text-[#38bdf8] transition-colors mb-3 uppercase italic tracking-tighter leading-none">{{ $article->title }}</h4>
                                ...
                                <div class="shrink-0 group-hover:translate-x-3 transition-transform duration-500">
                                    <div class="w-12 h-12 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-white/5 group-hover:bg-[#38bdf8] group-hover:border-[#38bdf8] group-hover:text-[#0a0e14] group-hover:shadow-xl group-hover:shadow-[#38bdf8]/20 transition-all">
