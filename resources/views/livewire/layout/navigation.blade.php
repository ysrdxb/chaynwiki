...
<nav x-data="{ open: false }" class="bg-white/5 border-b border-white/10 backdrop-blur-xl">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <span class="text-2xl font-display font-bold tracking-tighter text-white">ChaynWiki</span>
                    </a>
                </div>
