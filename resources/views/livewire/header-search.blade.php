<div class="relative w-full" x-data="{ focused: false }">
    <div class="relative group flex items-center bg-white/5 border border-white/10 rounded-full overflow-hidden focus-within:border-[#3b82f6] transition-colors">
        <input 
            type="text" 
            ...
            placeholder="Search" 
            class="flex-1 bg-transparent border-none focus:ring-0 text-sm text-white placeholder-white/40 px-4 py-2"
        >
