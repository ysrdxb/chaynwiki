<div class="relative w-full" x-data="{ focused: false }">
    <div class="relative group flex items-center bg-[#1c2128] border border-white/10 rounded-full overflow-hidden focus-within:border-white/20 transition-colors">
        <input 
            type="text" 
            ...
            class="flex-1 bg-transparent border-none focus:ring-0 text-[14px] text-white placeholder-white/20 px-5 py-2"
        >
