<div class="relative w-full" x-data="{ focused: false }">
    <div class="relative group">
        <svg class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30 group-focus-within:text-[#38bdf8] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <input 
            ...
            placeholder="Search..." 
            class="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus:border-[#38bdf8]/40 transition-colors"
        >
    </div>
