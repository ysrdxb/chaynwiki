...
<section>
    <header class="mb-10">
        <h2 class="text-2xl font-black text-white uppercase tracking-tightest" style="font-family: 'Moderniz', sans-serif;">
            SECURITY <span class="text-white/10 ml-2">/ PASSWORD</span>
        </h2>
        <p class="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] mt-2">Update your account password for security.</p>
    </header>

    <form wire:submit="updatePassword" class="space-y-8">
        <div class="space-y-3">
            <x-input-label for="update_password_current_password" :value="__('CURRENT PASSWORD')" class="text-[10px] font-black text-white/40 uppercase tracking-[0.4em] ml-1" />
        ...
        <div class="space-y-3">
            <x-input-label for="update_password_password" :value="__('NEW PASSWORD')" class="text-[10px] font-black text-white/40 uppercase tracking-[0.4em] ml-1" />
            <div class="relative group">
                <div class="absolute inset-0 bg-blue-500/5 rounded-2xl blur-xl group-focus-within:bg-blue-500/10 transition-all duration-500"></div>
        ...
        <div class="space-y-3">
            <x-input-label for="update_password_password_confirmation" :value="__('CONFIRM PASSWORD')" class="text-[10px] font-black text-white/40 uppercase tracking-[0.4em] ml-1" />
            <div class="relative group">
                <div class="absolute inset-0 bg-blue-500/5 rounded-2xl blur-xl group-focus-within:bg-blue-500/10 transition-all duration-500"></div>
