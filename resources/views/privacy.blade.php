    ...
    <section class="py-16 bg-secondary section-divider">
        <div class="max-w-[1200px] mx-auto px-8 space-y-6">
            <div class="bg-[#0D0D1A] border border-white/5 rounded-2xl p-6">
                ...
                <p class="text-white/50 text-sm">Account details, content edits, and engagement metrics needed for the public ledger.</p>
            </div>
            <div class="bg-[#0D0D1A] border border-white/5 rounded-2xl p-6">
                <h2 class="text-white font-black uppercase tracking-widest text-sm mb-3">How We Use Data</h2>
                <p class="text-white/50 text-sm">Data is used for authentication, moderation, and maintaining record integrity.</p>
            </div>
            <div class="bg-[#0D0D1A] border border-white/5 rounded-2xl p-6">
                <h2 class="text-white font-black uppercase tracking-widest text-sm mb-3">Your Control</h2>
                <p class="text-white/50 text-sm">You can update profile data and request account removal via settings.</p>
            </div>
        </div>
    </section>
@endsection
