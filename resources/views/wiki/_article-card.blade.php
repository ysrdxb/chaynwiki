    ...
    <div class="h-full flex flex-col card-premium-unified !p-0 border border-white/5 hover:border-blue-500/30 transition-all duration-500 shadow-3xl bg-[#161b22]/40 backdrop-blur-sm">
        ...
        <div class="relative aspect-[16/10] overflow-hidden group/img bg-[#1a1f26]">
            ...
            <div class="absolute inset-0 bg-blue-500/10 opacity-0 group-hover/img:opacity-100 transition-opacity flex items-center justify-center">
                  <div class="w-12 h-12 rounded-full bg-blue-500 text-navy-950 flex items-center justify-center scale-75 opacity-0 group-hover/img:scale-100 group-hover/img:opacity-100 transition-all duration-500 shadow-2xl">
        ...
        <div class="flex-1 flex flex-col p-6">
            ...
            <div class="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                ...
                <div class="group/btn flex items-center gap-2">
                    <div class="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/20 group-hover:bg-blue-500 group-hover:text-navy-950 transition-all duration-300">
