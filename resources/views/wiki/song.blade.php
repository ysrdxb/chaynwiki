    ...
    <div class="max-w-[1400px] w-full px-8 flex items-start gap-12 pt-32 pb-16">
        ...
        <aside class="hidden lg:block w-72 sticky top-32 shrink-0 space-y-2 pr-8 border-r border-white/5">
            ...
            @foreach($categories as $key => $cat)
                <a href="{{ route('wiki.index', ['category' => $key]) }}" class="group flex items-center gap-4 px-4 py-3 rounded-full text-[13px] font-bold transition-all border border-transparent {{ $key === 'song' ? 'bg-blue-500/10 text-white border-blue-500/20 shadow-[0_0_15px_rgba(59,130,246,0.2)]' : 'text-white/50 hover:text-white hover:bg-white/5 hover:border-white/5' }}">
                    <div class="w-8 h-8 rounded-full {{ $key === 'song' ? 'bg-blue-500 shadow-lg text-white' : 'bg-white/5 group-hover:bg-white/10' }} flex items-center justify-center transition-all">
            ...
            <div class="space-y-24">
                ...
                <section>
                    <div class="flex items-center border-b border-white/5 pb-6 mb-10">
                        <div class="w-1.5 h-16 bg-blue-500 rounded-full mr-6 shadow-[0_0_15px_rgba(59,130,246,0.5)]"></div>
                        <h2 class="text-5xl lg:text-7xl font-black text-white tracking-tighter uppercase leading-[0.9]">Musical<br>Analysis</h2>
                    </div>
