    ...
    <div class="relative max-w-[1400px] mx-auto px-8">
        <div class="h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                {{-- Submit Topic Button --}}
                <a href="{{ route('wiki.create') }}" class="hidden xl:flex items-center gap-4 px-6 py-2.5 bg-white/5 border border-white/10 text-white text-[13px] font-bold uppercase tracking-widest rounded-full hover:bg-white/10 transition-all ml-4 group">
                    <span>Submit Topic</span>
                    <div class="w-5 h-5 bg-[#3b82f6]/10 rounded-full flex items-center justify-center group-hover:bg-[#3b82f6] transition-all">
                        <svg class="w-3 h-3 text-[#3b82f6] group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 4v16m8-8H4"/></svg>
                    </div>
                </a>
