    ...
    <div class="relative max-w-[1400px] mx-auto px-8 pt-24 pb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-12 mb-24">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="https://facebook.com/chaynwiki" target="_blank" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all">
                    ...
                    <a href="https://instagram.com/chaynwiki" target="_blank" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all">
        ...
        <div class="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            <p class="text-white/20 text-[12px] font-bold uppercase tracking-widest">
                &copy; {{ date('Y') }} CHAYNWIKI. AN INDEPENDENT ARCHIVAL PLATFORM.
            </p>
