    ...
    <section class="py-16 bg-secondary section-divider">
        <div class="max-w-[1200px] mx-auto px-8 space-y-6">
            <div class="bg-[#0D0D1A] border border-white/5 rounded-2xl p-6">
                ...
                <p class="text-white/50 text-sm">Do not submit copyrighted material without permission.</p>
            </div>
            <div class="bg-[#0D0D1A] border border-white/5 rounded-2xl p-6">
                <h2 class="text-white font-black uppercase tracking-widest text-sm mb-3">Attribution</h2>
                <p class="text-white/50 text-sm">Edits are attributed to contributors for transparency.</p>
            </div>
            <div class="bg-[#0D0D1A] border border-white/5 rounded-2xl p-6">
                <h2 class="text-white font-black uppercase tracking-widest text-sm mb-3">Moderation</h2>
                <p class="text-white/50 text-sm">We reserve the right to remove content that violates policies.</p>
            </div>
        </div>
    </section>
@endsection
